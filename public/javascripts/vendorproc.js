...
function BuildMenu(data) {
    ...
    menushtml.append('<div class="itemsSearch"><input type="search" id="autocomplete" placeholder="Menu Item Search"/></div>');
    for (var m = 0; m < menus.length; m++) {
        ...
        menuhtml.append('</div>'); // close menu
    ...
    // close menuwrap
    $('#vomenu').html(menushtml.toString() + '<br class="clear" /></div>');
    $('#vomenu').trigger('create');
...
function binditem() {
    ...
    $('div.item').click(function () {
        ...
        $('#dcombo').popup({
            positionTo: "window", overlayTheme: "b", dismissible: false, transition: "pop", afteropen: function (event, ui) {
